...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    let last24hCount = Array.from({ length: 24 }, (_, i) => i).map((i: any) => {
        ...
        return {
            date: date,
            count: last24h.filter((member: any) => { return member.createdAt.getHours() === date.getHours(); }).length
        };
    });
    ...
    let last7dCount = Array.from({ length: 7 }, (_, i) => i).map((i: any) => {
        ...
        return {
            date: date,
            count: last7d.filter((member: any) => { return member.createdAt.getDate() === date.getDate(); }).length
        };
    });
    ...
    let last30dCount = Array.from({ length: 30 }, (_, i) => i).map((i: any) => {
        ...
        return {
            date: date,
            count: last30d.filter((member: any) => { return member.createdAt.getDate() === date.getDate(); }).length
        };
    });
