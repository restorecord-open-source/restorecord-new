                    ...
                    "Messages": [
                        {
                            ...
                            "TextPart": `Hello ${account.username},\n\nA Password reset has been requested, from ${data.city ?? "Unknown City"}, ${data.region ?? "Unknown Region"}, ${data.country ?? "Unknown Country"}.\n\nIf this was not you, you can safely ignore this email.\n\nRegards,\nRestoreCord`,
                            "HTMLPart": 
                                `
                                    <!DOCTYPE html>
                                    <html>
                                        ...
                                        <body>
                                            ...
                                            <div style="padding: 1rem; border-radius: 0.75rem; background: rgb(250, 250, 250);">
                                                ...
                                                <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                                                    ...
                                                    <br />
                                                    <b style="font-weight: 600">Location:</b> Near ${data.city ?? "Unknown City"}, ${data.region ?? "Unknown Region"}, ${data.country ?? "Unknown Country"}
                    ...
                    "Messages": [
                        {
                            ...
                            "TextPart": `Hello ${account.username},\n\nYour Password has been Changed, from ${data.city ?? "Unknown City"}, ${data.region ?? "Unknown Region"}, ${data.country ?? "Unknown Country"}.\n\nIf this was not you, please contact us at support@restorecord.com.\n\nRegards,\nRestoreCord`,
                            "HTMLPart": 
                                `
                                    <!DOCTYPE html>
                                    <html>
