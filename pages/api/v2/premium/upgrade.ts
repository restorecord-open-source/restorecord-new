                    ...
                    if (body.status === "COMPLETED") {
                        ...
                        if (account) {
                            ...
                            await Email.send({
                                ...
                                console.log(`[EMAIL] [${new Date().toLocaleString()}] Successfully upgraded ${body.additional_information[0].value} (${body.invoice.customer_information.email}) to ${body.listing.title}!`);
                            }).catch((err: any) => {
                                console.error(err);
                            })
                            ...
                            await Email.send({
                                ...
                                console.log(`[EMAIL] [${new Date().toLocaleString()}] Failed to upgraded ${body.additional_information[0].value} (${body.invoice.customer_information.email}) to ${body.listing.title}!`);
                            }).catch((err: any) => {
                                console.error(err);
                            });
