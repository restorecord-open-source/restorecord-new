                    ...
                    <div className="smx:pt-6 pt-4">
                        <div className="text-white text-2xl font-bold">
                            {status === "finished" ? (
                                ...
                                <a href={`https://discord.com/oauth2/authorize?client_id=${data.server.clientId}&redirect_uri=${window.location.origin}/api/callback&response_type=code&scope=identify+guilds.join&state=${data.server.guildId}&prompt=none`}>
