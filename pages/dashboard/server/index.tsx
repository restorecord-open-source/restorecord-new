                                                        ...
                                                        <Grid container spacing={3} direction="row" justifyContent={"space-between"}>
                                                            ...
                                                            <Grid item xs={12} sm={12} md={3} lg={2} xl={1}>
                                                                <Stack spacing={1} direction="column" justifyContent={"space-between"}>
                                                                    <Button variant="contained" onClick={() => { router.push(`/dashboard/server/${item.guildId}`)} }>
                                                                        Edit
                                                                    </Button>
                                            ...
                                            <CardContent>
                                                <Stack spacing={1} direction="column" justifyContent={"space-between"}>
                                                    <Alert variant="filled" severity="error">
                                                        You don&apos;t have any servers. You can add servers{" "}
                                                        <Link color={theme.palette.error.main} href="/dashboard/server" rel="noopener noreferrer" target="_blank">
                                                            here
                                                        </Link>.
                                                    </Alert>
                                                </Stack>
