...
export default function DashLoading() {
    return (
        <section style={{ padding: "0 160px", marginTop: "160px" }}>
            <Box sx={{ position: "relative", minWidth: "80vw", maxWidth: "80vw", minHeight: "60vh", maxHeight: "60vh", zIndex: 999, display: "flex", justifyContent: "center", alignItems: "center" }}>
                <svg id="Dashboard" className="image-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" style={{ position: "absolute", maxWidth: "80vw", maxHeight: "60vh", zIndex: 999 }}>
